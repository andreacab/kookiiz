...
<div class="column single" <?php if(!$User->isLogged()){echo 'style="display:none"';} ?>>
	<h5>
		<span><?php $Lang->p('SHARE_TITLES', 2); ?></span>
	</h5>
	<p>
		<span><?php $Lang->p('SHARE_TEXTS', 7); ?></span>
	</p>
	<div id="members_chart"></div>
	<hr />
	<p class="center">
		<img class="icon15 cookie1" src="<?php C::p('ICON_URL'); ?>" alt="<?php $Lang->p('KEYWORDS', 4); ?>" title="1 <?php $Lang->p('USER_GRADE_TEXT', 1); ?>" />
		<span>1 <?php $Lang->p('USER_GRADE_TEXT', 2); ?> | </span>
		<img class="icon15 cookie5" src="<?php C::p('ICON_URL'); ?>" alt="<?php $Lang->p('KEYWORDS', 4); ?>" title="5 <?php $Lang->p('USER_GRADE_TEXT', 1); ?>" />
		<span>5 <?php $Lang->p('USER_GRADE_TEXT', 3); ?> | </span>
		<img class="icon15 cookie10" src="<?php C::p('ICON_URL'); ?>" alt="<?php $Lang->p('KEYWORDS', 4); ?>" title="10 <?php $Lang->p('USER_GRADE_TEXT', 1); ?>" />
		<span>10 <?php $Lang->p('USER_GRADE_TEXT', 3); ?> | </span>
		<img class="icon15 cookie50" src="<?php C::p('ICON_URL'); ?>" alt="<?php $Lang->p('KEYWORDS', 4); ?>" title="50 <?php $Lang->p('USER_GRADE_TEXT', 1); ?>" />
		<span>50 <?php $Lang->p('USER_GRADE_TEXT', 3); ?></span>
	</p>
</div>