...
var RecipeTheme = Class.create(
{
    ...
    ********************************************************/
	...
	apply: function()
    {
        ...
        Kookiiz.recipes.search(criteria, false);
    ...
    ********************************************************/
	...
	display: function(container)
    {
        ...
        else theme_class += ' ' + this.name;

        //Build theme structure
        var theme           = new Element('div', {'class': theme_class});
        var theme_header    = new Element('div', {'class': 'header'});
        var theme_footer    = new Element('div', {'class': 'footer'});
        var theme_content   = new Element('div', {'class': 'content'});
        var theme_image     = new Element('div', {'class': 'image'});
        var theme_title     = new Element('h6', {'class': 'title center'});
        ...
        theme.observe('click', this.click.bind(this));
